...
#include "ModelSinFCM_capi.h"
#include <math.h>
#include "ModelSinFCM.h"
#include "ModelSinFCM_private.h"
#include "ModelSinFCM_dt.h"
...
"slprj//raccel//ModelSinFCM//ModelSinFCM_Jpattern.mat" ; const int_T
...
& model_S ; static real_T eywpzgqclg ( real_T x ) ; static real_T eywpzgqclgi
( real_T x ) ; static real_T eywpzgqclgib ( real_T x ) ; static real_T
eywpzgqclgibq ( real_T x ) ; static real_T eywpzgqclgibqu ( real_T x ) ;
static real_T eywpzgqclgibqun ( real_T x ) ; static real_T hutaqknbtk (
real_T x ) ; static real_T epvajuano1 ( real_T x ) ; static real_T m3yjneqk54
( real_T x ) ; static real_T ac1qin3ojd ( real_T x ) ; static real_T
hmyiupnrzi ( real_T x ) ; static real_T lr4ldwtoai ( real_T x ) ; static
real_T d5ak5avp5n ( real_T x ) ; static real_T cdobiqbert ( real_T x ) ;
static real_T mrofavnvjw ( real_T x ) ; static real_T lmuowx0fbh ( real_T x )
; static real_T l5mgrem1b2 ( real_T x ) ; static real_T psqn1eymce ( real_T x
) ; static real_T lzjuiphko2 ( real_T x ) ; static real_T ln1jnmxr2d ( real_T
x ) ; static real_T byz3znvxgl ( real_T x ) ; static real_T oipi1pqiqd (
real_T x ) ; static real_T gpkd4zqojt ( real_T x ) ; static real_T l2r14znrn1
( real_T x ) ; static real_T a2jrhsyoxr ( real_T x ) ; static real_T
h0vnfbmwfo ( real_T x ) ; static real_T b1311bdz4t ( real_T x ) ; static
real_T dw4dlwwbse ( real_T x ) ; static real_T b33vtaz44k ( real_T x ) ;
static real_T cecpahe0po ( real_T x ) ; static real_T fajjty1xc3 ( real_T x )
; static real_T pa4dgfvwvq ( real_T x ) ; static real_T ambn15gfjv ( real_T x
) ; static real_T l3hjzsspfy ( real_T x ) ; static real_T d0q13n0oyn ( real_T
x ) ; static real_T l02vigv21f ( real_T x ) ; static real_T m5on5dnrmy (
real_T x ) ; static real_T e0nwr1xyco ( real_T x ) ; static real_T crdkgjlncr
( real_T x ) ; static real_T lchkpegmzo ( real_T x ) ; static real_T
dvuatoftpk ( real_T x ) ; static real_T khiqlbce1l ( real_T x ) ; static
real_T p0ydfhvwug ( real_T x ) ; static real_T nrranyddj5 ( real_T x ) ;
static real_T duc3guapz1 ( real_T x ) ; static real_T fiutxvajap ( real_T x )
; static real_T b5tytbopgq ( real_T x ) ; static real_T ocgzwp0lsm ( real_T x
) ; static real_T czvohqdler ( real_T x ) ; static real_T fz4nn4eqtj ( real_T
x ) ; static real_T j2qmajqary ( real_T x ) ; static real_T prsoxeitns (
real_T x ) ; static real_T htit42kwsn ( real_T x ) ; static real_T pvidvvldo4
( real_T x ) ; static real_T jpxasba52w ( real_T x ) ; static real_T
bprzeobosc ( real_T x ) ; static real_T nznqtfkiwv ( real_T x ) ; static
real_T fx5iueylqp ( real_T x ) ; static real_T e5lwhyp1zx ( real_T x ) ;
static real_T dq145ay1jx ( real_T x ) ; static real_T gslfl3sflz ( real_T x )
; static real_T cxjr1kogx4 ( real_T x ) ; static real_T ml5u3ddzxo ( real_T x
) ; static real_T b1sskp5kwl ( real_T x ) ; static real_T dn33aq2wg3 ( real_T
x ) ; static real_T fdsv1qywzg ( real_T x ) ; static real_T mq0iasf2oh (
real_T x ) ; static real_T ia2wt1f44w ( real_T x ) ; static real_T ongg21fdbs
( real_T x ) ; static real_T ppcecntzeg ( real_T x ) ; static void cheur1i43x
( const real_T inputs [ 6 ] , real_T inputMFCache [ 102 ] ) ; static void
fmt2dpdmkg ( const real_T inputs [ 6 ] , real_T outputMFCache [ 17 ] ) ;
static int32_T cba4ev4jvs ( int32_T x ) ; static real_T d42r14qxa4 ( const
real_T x [ 2 ] ) ; static real_T eywpzgqclg ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.4272301312496628 ) * ( x - 0.4272301312496628
) ) / 0.10353291020232459 ) ; } static real_T eywpzgqclgi ( real_T x ) {
return muDoubleScalarExp ( - ( ( x - - 0.38122150403267741 ) * ( x - -
0.38122150403267741 ) ) / 0.13483886670591741 ) ; } static real_T
eywpzgqclgib ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.21392751723934378 ) * ( x - 0.21392751723934378 ) ) / 0.095303012393148548
) ; } static real_T eywpzgqclgibq ( real_T x ) { return muDoubleScalarExp ( -
( ( x - 0.1628782151721947 ) * ( x - 0.1628782151721947 ) ) /
0.095511337905905866 ) ; } static real_T eywpzgqclgibqu ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.87574614633768355 ) * ( x - -
0.87574614633768355 ) ) / 0.2641990004187067 ) ; } static real_T
eywpzgqclgibqun ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.34740147636502611 ) * ( x - 0.34740147636502611 ) ) / 0.10433093567690199 )
; } static real_T hutaqknbtk ( real_T x ) { return muDoubleScalarExp ( - ( (
x - 0.5077153474611914 ) * ( x - 0.5077153474611914 ) ) / 0.11856916238113138
) ; } static real_T epvajuano1 ( real_T x ) { return muDoubleScalarExp ( - (
( x - 0.37915147333803695 ) * ( x - 0.37915147333803695 ) ) /
0.10754982224821612 ) ; } static real_T m3yjneqk54 ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.63464252114465636 ) * ( x -
0.63464252114465636 ) ) / 0.14115962423861467 ) ; } static real_T ac1qin3ojd
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.55643794609812292 ) *
( x - - 0.55643794609812292 ) ) / 0.16343678290821437 ) ; } static real_T
hmyiupnrzi ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.33126530753385863 ) * ( x - - 0.33126530753385863 ) ) / 0.12824188795545369
) ; } static real_T lr4ldwtoai ( real_T x ) { return muDoubleScalarExp ( - (
( x - 0.52964566921541933 ) * ( x - 0.52964566921541933 ) ) /
0.11536996208778183 ) ; } static real_T d5ak5avp5n ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.38420158807881744 ) * ( x -
0.38420158807881744 ) ) / 0.10538270425643964 ) ; } static real_T cdobiqbert
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.1876838424304143 ) *
( x - - 0.1876838424304143 ) ) / 0.10818531265583192 ) ; } static real_T
mrofavnvjw ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.64632104522579426 ) * ( x - - 0.64632104522579426 ) ) / 0.18368007650515977
) ; } static real_T lmuowx0fbh ( real_T x ) { return muDoubleScalarExp ( - (
( x - 0.26598642596556538 ) * ( x - 0.26598642596556538 ) ) /
0.096674801421306952 ) ; } static real_T l5mgrem1b2 ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.18869423900527227 ) * ( x - -
0.18869423900527227 ) ) / 0.11116503229140566 ) ; } static real_T psqn1eymce
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.58491783430897049 ) * (
x - 0.58491783430897049 ) ) / 0.12105749995193932 ) ; } static real_T
lzjuiphko2 ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.099546831289757623 ) * ( x - 0.099546831289757623 ) ) /
0.099534354161767341 ) ; } static real_T ln1jnmxr2d ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.80562904959923543 ) * ( x -
0.80562904959923543 ) ) / 0.18452399221872162 ) ; } static real_T byz3znvxgl
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.22571986359749013 ) *
( x - - 0.22571986359749013 ) ) / 0.11763679189540593 ) ; } static real_T
oipi1pqiqd ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.39868417440681 ) * ( x - 0.39868417440681 ) ) / 0.10073325645436502 ) ; }
static real_T gpkd4zqojt ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.36502691941392046 ) * ( x - 0.36502691941392046 ) ) / 0.10483688071748885 )
; } static real_T l2r14znrn1 ( real_T x ) { return muDoubleScalarExp ( - ( (
x - - 0.28786940486878165 ) * ( x - - 0.28786940486878165 ) ) /
0.12201616351057286 ) ; } static real_T a2jrhsyoxr ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.078504766236272464 ) * ( x -
0.078504766236272464 ) ) / 0.10143004342284434 ) ; } static real_T h0vnfbmwfo
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.39033118381429005 ) * (
x - 0.39033118381429005 ) ) / 0.10582720515730709 ) ; } static real_T
b1311bdz4t ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.057602037492957864 ) * ( x - 0.057602037492957864 ) ) /
0.096186775115820786 ) ; } static real_T dw4dlwwbse ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.216434702750021 ) * ( x - 0.216434702750021 )
) / 0.1005830801726499 ) ; } static real_T b33vtaz44k ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.707109888832952 ) * ( x - -
0.707109888832952 ) ) / 0.21149390832396983 ) ; } static real_T cecpahe0po (
real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.14599433270444895 ) * (
x - - 0.14599433270444895 ) ) / 0.10947459073983087 ) ; } static real_T
fajjty1xc3 ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.595700234371761 ) * ( x - - 0.595700234371761 ) ) / 0.18195022372484873 ) ;
} static real_T pa4dgfvwvq ( real_T x ) { return muDoubleScalarExp ( - ( ( x
- - 0.6270683747493937 ) * ( x - - 0.6270683747493937 ) ) /
0.18316497444018076 ) ; } static real_T ambn15gfjv ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.092558714475513032 ) * ( x -
0.092558714475513032 ) ) / 0.098501236640537823 ) ; } static real_T
l3hjzsspfy ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.37243782186824842 ) * ( x - 0.37243782186824842 ) ) / 0.10586347254160451 )
; } static real_T d0q13n0oyn ( real_T x ) { return muDoubleScalarExp ( - ( (
x - 0.30355151431010247 ) * ( x - 0.30355151431010247 ) ) /
0.094788504909532112 ) ; } static real_T l02vigv21f ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.12091202242700798 ) * ( x - -
0.12091202242700798 ) ) / 0.10879901986798192 ) ; } static real_T m5on5dnrmy
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.11137195859648541 ) * (
x - 0.11137195859648541 ) ) / 0.097019975147369167 ) ; } static real_T
e0nwr1xyco ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.4576065437738252 ) * ( x - - 0.4576065437738252 ) ) / 0.15403969421870939 )
; } static real_T crdkgjlncr ( real_T x ) { return muDoubleScalarExp ( - ( (
x - 0.54024022430916208 ) * ( x - 0.54024022430916208 ) ) /
0.12385927483156207 ) ; } static real_T lchkpegmzo ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.078657127588490541 ) * ( x -
0.078657127588490541 ) ) / 0.10204558029971353 ) ; } static real_T dvuatoftpk
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.64807092243719266 ) * (
x - 0.64807092243719266 ) ) / 0.15022740866353707 ) ; } static real_T
khiqlbce1l ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.45599572937194 ) * ( x - 0.45599572937194 ) ) / 0.12222485512415057 ) ; }
static real_T p0ydfhvwug ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
- 0.40665974489531309 ) * ( x - - 0.40665974489531309 ) ) /
0.14549979563917961 ) ; } static real_T nrranyddj5 ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.46007365288648805 ) * ( x -
0.46007365288648805 ) ) / 0.11455418797226287 ) ; } static real_T duc3guapz1
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.23576665232267591 ) *
( x - - 0.23576665232267591 ) ) / 0.12185423174438191 ) ; } static real_T
fiutxvajap ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.60175306719620336 ) * ( x - - 0.60175306719620336 ) ) / 0.1826426694350502
) ; } static real_T b5tytbopgq ( real_T x ) { return muDoubleScalarExp ( - (
( x - - 0.041744382151104056 ) * ( x - - 0.041744382151104056 ) ) /
0.10193701245157658 ) ; } static real_T ocgzwp0lsm ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.26759865164897473 ) * ( x -
0.26759865164897473 ) ) / 0.099856294415290023 ) ; } static real_T czvohqdler
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.11221896823937631 ) * (
x - 0.11221896823937631 ) ) / 0.091842093852220641 ) ; } static real_T
fz4nn4eqtj ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.51084467204420958 ) * ( x - 0.51084467204420958 ) ) / 0.125162738692711 ) ;
} static real_T j2qmajqary ( real_T x ) { return muDoubleScalarExp ( - ( ( x
- - 0.27938198154342525 ) * ( x - - 0.27938198154342525 ) ) /
0.12734292586523141 ) ; } static real_T prsoxeitns ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 1.3370371366435285 ) * ( x - -
1.3370371366435285 ) ) / 0.57306762799734412 ) ; } static real_T htit42kwsn (
real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.32116702997552188 ) * (
x - - 0.32116702997552188 ) ) / 0.22206071551125431 ) ; } static real_T
pvidvvldo4 ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.66770996443313213 ) * ( x - 0.66770996443313213 ) ) / 0.22388741463107545 )
; } static real_T jpxasba52w ( real_T x ) { return muDoubleScalarExp ( - ( (
x - - 0.53461062511531954 ) * ( x - - 0.53461062511531954 ) ) /
0.26267151927461407 ) ; } static real_T bprzeobosc ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.27082944020666111 ) * ( x -
0.27082944020666111 ) ) / 0.1755260253046293 ) ; } static real_T nznqtfkiwv (
real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.73823475183345422 ) * ( x
- 0.73823475183345422 ) ) / 0.24457499541138669 ) ; } static real_T
fx5iueylqp ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.27498656618416162 ) * ( x - - 0.27498656618416162 ) ) / 0.20934905585201147
) ; } static real_T e5lwhyp1zx ( real_T x ) { return muDoubleScalarExp ( - (
( x - 0.40671543302691848 ) * ( x - 0.40671543302691848 ) ) /
0.19349505666770106 ) ; } static real_T dq145ay1jx ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.10894574982571106 ) * ( x - -
0.10894574982571106 ) ) / 0.19643240399360731 ) ; } static real_T gslfl3sflz
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.670310885810292 ) * (
x - - 0.670310885810292 ) ) / 0.28939538251236052 ) ; } static real_T
cxjr1kogx4 ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.0461396546301467 ) * ( x - 0.0461396546301467 ) ) / 0.18946957931887054 ) ;
} static real_T ml5u3ddzxo ( real_T x ) { return muDoubleScalarExp ( - ( ( x
- - 0.038580155059423138 ) * ( x - - 0.038580155059423138 ) ) /
0.1797408221459087 ) ; } static real_T b1sskp5kwl ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 1.0043200260380656 ) * ( x - 1.0043200260380656
) ) / 0.319429596586301 ) ; } static real_T dn33aq2wg3 ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.21686803079518993 ) * ( x -
0.21686803079518993 ) ) / 0.18494218094834705 ) ; } static real_T fdsv1qywzg
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.82695669403376471 ) * (
x - 0.82695669403376471 ) ) / 0.24989720123519241 ) ; } static real_T
mq0iasf2oh ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.73925816858408411 ) * ( x - - 0.73925816858408411 ) ) / 0.31916866535867194
) ; } static real_T ia2wt1f44w ( real_T x ) { return muDoubleScalarExp ( - (
( x - - 0.0967855833913881 ) * ( x - - 0.0967855833913881 ) ) /
0.198276278637146 ) ; } static real_T ongg21fdbs ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.47543313661233289 ) * ( x -
0.47543313661233289 ) ) / 0.18732932695051252 ) ; } static real_T ppcecntzeg
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.55833509966857442 ) *
( x - - 0.55833509966857442 ) ) / 0.26639484250937323 ) ; } static void
cheur1i43x ( const real_T inputs [ 6 ] , real_T inputMFCache [ 102 ] ) {
inputMFCache [ 0 ] = eywpzgqclg ( inputs [ 0 ] ) ; inputMFCache [ 1 ] =
eywpzgqclgi ( inputs [ 0 ] ) ; inputMFCache [ 2 ] = eywpzgqclgib ( inputs [ 0
] ) ; inputMFCache [ 3 ] = eywpzgqclgibq ( inputs [ 0 ] ) ; inputMFCache [ 4
] = eywpzgqclgibqu ( inputs [ 0 ] ) ; inputMFCache [ 5 ] = eywpzgqclgibqun (
inputs [ 0 ] ) ; inputMFCache [ 6 ] = hutaqknbtk ( inputs [ 0 ] ) ;
inputMFCache [ 7 ] = epvajuano1 ( inputs [ 0 ] ) ; inputMFCache [ 8 ] =
m3yjneqk54 ( inputs [ 0 ] ) ; inputMFCache [ 9 ] = ac1qin3ojd ( inputs [ 0 ]
) ; inputMFCache [ 10 ] = hmyiupnrzi ( inputs [ 0 ] ) ; inputMFCache [ 11 ] =
lr4ldwtoai ( inputs [ 0 ] ) ; inputMFCache [ 12 ] = d5ak5avp5n ( inputs [ 0 ]
) ; inputMFCache [ 13 ] = cdobiqbert ( inputs [ 0 ] ) ; inputMFCache [ 14 ] =
mrofavnvjw ( inputs [ 0 ] ) ; inputMFCache [ 15 ] = lmuowx0fbh ( inputs [ 0 ]
) ; inputMFCache [ 16 ] = l5mgrem1b2 ( inputs [ 0 ] ) ; inputMFCache [ 17 ] =
psqn1eymce ( inputs [ 1 ] ) ; inputMFCache [ 18 ] = lzjuiphko2 ( inputs [ 1 ]
) ; inputMFCache [ 19 ] = ln1jnmxr2d ( inputs [ 1 ] ) ; inputMFCache [ 20 ] =
byz3znvxgl ( inputs [ 1 ] ) ; inputMFCache [ 21 ] = oipi1pqiqd ( inputs [ 1 ]
) ; inputMFCache [ 22 ] = gpkd4zqojt ( inputs [ 1 ] ) ; inputMFCache [ 23 ] =
l2r14znrn1 ( inputs [ 1 ] ) ; inputMFCache [ 24 ] = a2jrhsyoxr ( inputs [ 1 ]
) ; inputMFCache [ 25 ] = h0vnfbmwfo ( inputs [ 1 ] ) ; inputMFCache [ 26 ] =
b1311bdz4t ( inputs [ 1 ] ) ; inputMFCache [ 27 ] = dw4dlwwbse ( inputs [ 1 ]
) ; inputMFCache [ 28 ] = b33vtaz44k ( inputs [ 1 ] ) ; inputMFCache [ 29 ] =
cecpahe0po ( inputs [ 1 ] ) ; inputMFCache [ 30 ] = fajjty1xc3 ( inputs [ 1 ]
) ; inputMFCache [ 31 ] = pa4dgfvwvq ( inputs [ 1 ] ) ; inputMFCache [ 32 ] =
ambn15gfjv ( inputs [ 1 ] ) ; inputMFCache [ 33 ] = l3hjzsspfy ( inputs [ 1 ]
) ; inputMFCache [ 34 ] = d0q13n0oyn ( inputs [ 2 ] ) ; inputMFCache [ 35 ] =
l02vigv21f ( inputs [ 2 ] ) ; inputMFCache [ 36 ] = m5on5dnrmy ( inputs [ 2 ]
) ; inputMFCache [ 37 ] = e0nwr1xyco ( inputs [ 2 ] ) ; inputMFCache [ 38 ] =
crdkgjlncr ( inputs [ 2 ] ) ; inputMFCache [ 39 ] = lchkpegmzo ( inputs [ 2 ]
) ; inputMFCache [ 40 ] = dvuatoftpk ( inputs [ 2 ] ) ; inputMFCache [ 41 ] =
khiqlbce1l ( inputs [ 2 ] ) ; inputMFCache [ 42 ] = p0ydfhvwug ( inputs [ 2 ]
) ; inputMFCache [ 43 ] = nrranyddj5 ( inputs [ 2 ] ) ; inputMFCache [ 44 ] =
duc3guapz1 ( inputs [ 2 ] ) ; inputMFCache [ 45 ] = fiutxvajap ( inputs [ 2 ]
) ; inputMFCache [ 46 ] = b5tytbopgq ( inputs [ 2 ] ) ; inputMFCache [ 47 ] =
ocgzwp0lsm ( inputs [ 2 ] ) ; inputMFCache [ 48 ] = czvohqdler ( inputs [ 2 ]
) ; inputMFCache [ 49 ] = fz4nn4eqtj ( inputs [ 2 ] ) ; inputMFCache [ 50 ] =
j2qmajqary ( inputs [ 2 ] ) ; inputMFCache [ 51 ] = prsoxeitns ( inputs [ 3 ]
) ; inputMFCache [ 52 ] = htit42kwsn ( inputs [ 3 ] ) ; inputMFCache [ 53 ] =
pvidvvldo4 ( inputs [ 3 ] ) ; inputMFCache [ 54 ] = jpxasba52w ( inputs [ 3 ]
) ; inputMFCache [ 55 ] = bprzeobosc ( inputs [ 3 ] ) ; inputMFCache [ 56 ] =
nznqtfkiwv ( inputs [ 3 ] ) ; inputMFCache [ 57 ] = fx5iueylqp ( inputs [ 3 ]
) ; inputMFCache [ 58 ] = e5lwhyp1zx ( inputs [ 3 ] ) ; inputMFCache [ 59 ] =
dq145ay1jx ( inputs [ 3 ] ) ; inputMFCache [ 60 ] = gslfl3sflz ( inputs [ 3 ]
) ; inputMFCache [ 61 ] = cxjr1kogx4 ( inputs [ 3 ] ) ; inputMFCache [ 62 ] =
ml5u3ddzxo ( inputs [ 3 ] ) ; inputMFCache [ 63 ] = b1sskp5kwl ( inputs [ 3 ]
) ; inputMFCache [ 64 ] = dn33aq2wg3 ( inputs [ 3 ] ) ; inputMFCache [ 65 ] =
fdsv1qywzg ( inputs [ 3 ] ) ; inputMFCache [ 66 ] = mq0iasf2oh ( inputs [ 3 ]
) ; inputMFCache [ 67 ] = ia2wt1f44w ( inputs [ 3 ] ) ; inputMFCache [ 68 ] =
ongg21fdbs ( inputs [ 4 ] ) ; inputMFCache [ 69 ] = ppcecntzeg ( inputs [ 4 ]
...
0.00029422377851906186 ; } static int32_T cba4ev4jvs ( int32_T x ) { int32_T
y ; if ( x < 0 ) { if ( x <= MIN_int32_T ) { y = MAX_int32_T ; } else { y = -
x ; } } else { y = x ; } return y ; } static real_T d42r14qxa4 ( const real_T
x [ 2 ] ) { return x [ 0 ] * x [ 1 ] ; } void MdlInitialize ( void ) { rtX .
medvodjkju [ 0 ] = 0.0 ; rtX . medvodjkju [ 1 ] = 0.0 ; rtX . medvodjkju [ 2
] = 0.0 ; rtDW . bulr31xmxq = rtP . UnitDelay3_InitialCondition ; rtDW .
d1wqa1xtnn = rtP . UnitDelay4_InitialCondition ; rtDW . fsyjap4cce = rtP .
UnitDelay5_InitialCondition ; rtDW . jyw0hnivmr = rtP .
UnitDelay_InitialCondition ; rtDW . mwcu1ayxzo = rtP .
UnitDelay1_InitialCondition ; rtDW . l03y1qu4w2 = rtP .
UnitDelay2_InitialCondition ; rtX . ki0ptsooxy = rtP . Integrator_IC ; } void
...
"ModelSinFCM/To Workspace" ; rtDW . coagtvkc0o . LoggedData =
...
coagtvkc0o . LoggedData == ( NULL ) ) return ; } MdlInitialize ( ) ; } void
...
real_T tmp [ 6 ] ; real_T flspdolsn3 [ 2 ] ; int32_T q0 ; int32_T q1 ; rtB .
kadysaqch1 = 0.0 ; rtB . kadysaqch1 += rtP . TransferFcn_C [ 0 ] * rtX .
medvodjkju [ 0 ] ; rtB . kadysaqch1 += rtP . TransferFcn_C [ 1 ] * rtX .
medvodjkju [ 1 ] ; rtB . kadysaqch1 += rtP . TransferFcn_C [ 2 ] * rtX .
medvodjkju [ 2 ] ; if ( ssIsSampleHit ( rtS , 1 , 0 ) ) { rtB . m5drxwofjk =
rtDW . bulr31xmxq ; rtB . dzhddfxbwe = rtDW . d1wqa1xtnn ; rtB . j3dbffcid2 =
rtDW . fsyjap4cce ; rtB . iwm2bj0n10 = rtDW . jyw0hnivmr ; rtB . fdxj3hwbrm =
rtDW . mwcu1ayxzo ; rtB . csuue5hgro = rtDW . l03y1qu4w2 ; if ( ssIsSampleHit
( rtS , 1 , 0 ) ) { sumAntecedentOutputs = 0.0 ; tmp [ 0 ] = rtB . m5drxwofjk
; tmp [ 1 ] = rtB . dzhddfxbwe ; tmp [ 2 ] = rtB . j3dbffcid2 ; tmp [ 3 ] =
rtB . iwm2bj0n10 ; tmp [ 4 ] = rtB . fdxj3hwbrm ; tmp [ 5 ] = rtB .
csuue5hgro ; cheur1i43x ( tmp , inputMFCache ) ; aggregatedOutputs = 0.0 ;
tmp [ 0 ] = rtB . m5drxwofjk ; tmp [ 1 ] = rtB . dzhddfxbwe ; tmp [ 2 ] = rtB
. j3dbffcid2 ; tmp [ 3 ] = rtB . iwm2bj0n10 ; tmp [ 4 ] = rtB . fdxj3hwbrm ;
tmp [ 5 ] = rtB . csuue5hgro ; fmt2dpdmkg ( tmp , outputMFCache ) ; for ( iy
= 0 ; iy < 17 ; iy ++ ) { cjmbdwlftv [ iy ] = 1.0 ; for ( inputID = 0 ;
inputID < 6 ; inputID ++ ) { q0 = cba4ev4jvs ( 17 * inputID ) ; flspdolsn3 [
0 ] = cjmbdwlftv [ iy ] ; q1 = b [ 17 * inputID + iy ] ; if ( ( q0 < 0 ) && (
q1 < MIN_int32_T - q0 ) ) { q0 = MIN_int32_T ; } else if ( ( q0 > 0 ) && ( q1
> MAX_int32_T - q0 ) ) { q0 = MAX_int32_T ; } else { q0 += q1 ; } flspdolsn3
[ 1 ] = inputMFCache [ q0 - 1 ] ; cjmbdwlftv [ iy ] = d42r14qxa4 ( flspdolsn3
) ; } sumAntecedentOutputs += cjmbdwlftv [ iy ] ; aggregatedOutputs +=
outputMFCache [ iy ] * cjmbdwlftv [ iy ] ; } if ( sumAntecedentOutputs == 0.0
) { rtB . byihanwml4 = - 0.1526961 ; } else { rtB . byihanwml4 = 1.0 /
sumAntecedentOutputs * aggregatedOutputs ; } } } rtB . fcbwvaph0s = rtX .
ki0ptsooxy ; { double locTime = ssGetTaskTime ( rtS , 0 ) ; ; if (
...
StructLogVar * ) rtDW . coagtvkc0o . LoggedData , & locTime , & rtB .
fcbwvaph0s ) ; } } } } if ( ssIsSampleHit ( rtS , 2 , 0 ) ) { } if (
ssIsSampleHit ( rtS , 1 , 0 ) && ssIsSampleHit ( rtS , 2 , 0 ) ) { rtB .
f2b5pdycws [ 0 ] = rtB . m5drxwofjk ; rtB . f2b5pdycws [ 1 ] = rtB .
dzhddfxbwe ; rtB . f2b5pdycws [ 2 ] = rtB . j3dbffcid2 ; rtB . f2b5pdycws [ 3
] = rtB . iwm2bj0n10 ; rtB . f2b5pdycws [ 4 ] = rtB . fdxj3hwbrm ; rtB .
f2b5pdycws [ 5 ] = rtB . csuue5hgro ; } rtB . pfc22v3jo0 = rtB . kadysaqch1 -
rtB . byihanwml4 ; rtB . pzdbswlimo = rtB . pfc22v3jo0 * rtB . pfc22v3jo0 ;
rtB . kdzq15v03v = muDoubleScalarSin ( rtP . SignalGenerator_Frequency *
ssGetT ( rtS ) ) * rtP . SignalGenerator_Amplitude ; UNUSED_PARAMETER ( tid )
; } void MdlUpdate ( int_T tid ) { if ( ssIsSampleHit ( rtS , 1 , 0 ) ) {
rtDW . bulr31xmxq = rtB . kadysaqch1 ; rtDW . d1wqa1xtnn = rtB . m5drxwofjk ;
rtDW . fsyjap4cce = rtB . dzhddfxbwe ; rtDW . jyw0hnivmr = rtB . kdzq15v03v ;
rtDW . mwcu1ayxzo = rtB . iwm2bj0n10 ; rtDW . l03y1qu4w2 = rtB . fdxj3hwbrm ;
...
rtS ) ) ; _rtXdot -> medvodjkju [ 0 ] = 0.0 ; _rtXdot -> medvodjkju [ 0 ] +=
rtP . TransferFcn_A [ 0 ] * rtX . medvodjkju [ 0 ] ; _rtXdot -> medvodjkju [
1 ] = 0.0 ; _rtXdot -> medvodjkju [ 0 ] += rtP . TransferFcn_A [ 1 ] * rtX .
medvodjkju [ 1 ] ; _rtXdot -> medvodjkju [ 2 ] = 0.0 ; _rtXdot -> medvodjkju
[ 0 ] += rtP . TransferFcn_A [ 2 ] * rtX . medvodjkju [ 2 ] ; _rtXdot ->
medvodjkju [ 1 ] += rtX . medvodjkju [ 0 ] ; _rtXdot -> medvodjkju [ 2 ] +=
rtX . medvodjkju [ 1 ] ; _rtXdot -> medvodjkju [ 0 ] += rtB . kdzq15v03v ;
_rtXdot -> ki0ptsooxy = rtB . pzdbswlimo ; } void MdlProjection ( void ) { }
...
void raccel_set_checksum ( ) { ssSetChecksumVal ( rtS , 0 , 486214536U ) ;
ssSetChecksumVal ( rtS , 1 , 3762856428U ) ; ssSetChecksumVal ( rtS , 2 ,
874934204U ) ; ssSetChecksumVal ( rtS , 3 , 2634502564U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
ModelSinFCM_InitializeDataMapInfo ( ) ; ssSetIsRapidAcceleratorActive ( rtS ,
true ) ; ssSetRootSS ( rtS , rtS ) ; ssSetVersion ( rtS ,
SIMSTRUCT_VERSION_LEVEL2 ) ; ssSetModelName ( rtS , "ModelSinFCM" ) ;
ssSetPath ( rtS , "ModelSinFCM" ) ; ssSetTStart ( rtS , 0.0 ) ; ssSetTFinal (
rtS , 500.0 ) ; { static RTWLogInfo rt_DataLoggingInfo ; rt_DataLoggingInfo .
...
byihanwml4 ) , ( NULL ) } } ; ssSetSolverRelTol ( rtS , 0.0001 ) ;
...
ssSetChecksumVal ( rtS , 0 , 486214536U ) ; ssSetChecksumVal ( rtS , 1 ,
3762856428U ) ; ssSetChecksumVal ( rtS , 2 , 874934204U ) ; ssSetChecksumVal
( rtS , 3 , 2634502564U ) ; { static const sysRanDType rtAlwaysEnabled =

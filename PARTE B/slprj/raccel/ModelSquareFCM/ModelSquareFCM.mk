...
MODEL                  = ModelSquareFCM
MODULES                = rt_logging.c ModelSquareFCM.c ModelSquareFCM_capi.c ModelSquareFCM_data.c ModelSquareFCM_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE               = ModelSquareFCM.mk
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/ModelSquareFCM \

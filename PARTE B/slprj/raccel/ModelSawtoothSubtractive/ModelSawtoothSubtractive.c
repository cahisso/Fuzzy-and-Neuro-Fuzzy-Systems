...
#include "ModelSawtoothSubtractive_capi.h"
#include <math.h>
#include "ModelSawtoothSubtractive.h"
#include "ModelSawtoothSubtractive_private.h"
#include "ModelSawtoothSubtractive_dt.h"
...
"slprj//raccel//ModelSawtoothSubtractive//ModelSawtoothSubtractive_Jpattern.mat"
...
& model_S ; static real_T bmzcvo0p3n ( real_T x ) ; static real_T bmzcvo0p3no
( real_T x ) ; static real_T bmzcvo0p3nof ( real_T x ) ; static real_T
bmzcvo0p3nofd ( real_T x ) ; static real_T bmzcvo0p3nofde ( real_T x ) ;
static real_T bmzcvo0p3nofde2 ( real_T x ) ; static real_T hahjh0cqdh (
real_T x ) ; static real_T ozjygdmcl0 ( real_T x ) ; static real_T p0mcyrspyt
( real_T x ) ; static real_T mhzimhcwrv ( real_T x ) ; static real_T
mkhx2ajthp ( real_T x ) ; static real_T nlkytdfkd0 ( real_T x ) ; static
real_T jnknbil0xi ( real_T x ) ; static real_T patfsraimm ( real_T x ) ;
static real_T cucglj540b ( real_T x ) ; static real_T ogq5bebiik ( real_T x )
; static real_T ngyjjhi1zl ( real_T x ) ; static real_T bu3s5hohn4 ( real_T x
) ; static real_T kxgbz20klu ( real_T x ) ; static real_T gt0euygakx ( real_T
x ) ; static real_T cqhezzc3df ( real_T x ) ; static real_T egh352mxwv (
real_T x ) ; static real_T kgnzygto43 ( real_T x ) ; static real_T dchdafquco
( real_T x ) ; static real_T f0stdv0qsz ( real_T x ) ; static real_T
bpgecejhpq ( real_T x ) ; static real_T dkwmvdok1w ( real_T x ) ; static
real_T nxbh2azmdh ( real_T x ) ; static real_T ffgmujot5v ( real_T x ) ;
static real_T jvnvwzhhvf ( real_T x ) ; static real_T a4mmwpbrs5 ( real_T x )
; static real_T k254wgfo5k ( real_T x ) ; static real_T oik3dynthb ( real_T x
) ; static real_T hfhajfa010 ( real_T x ) ; static real_T pzoxdxg5q5 ( real_T
x ) ; static real_T hqrqynqisg ( real_T x ) ; static real_T nsvq13xquu (
real_T x ) ; static real_T eca3tx2uet ( real_T x ) ; static real_T f05zto01zx
( real_T x ) ; static real_T d2km4x2m42 ( real_T x ) ; static real_T
i5nyhlozor ( real_T x ) ; static real_T nezhlmbv4d ( real_T x ) ; static
real_T mvuwg1yb3x ( real_T x ) ; static real_T b0w4cxcqjy ( real_T x ) ;
static real_T hxprwsi21x ( real_T x ) ; static real_T dqdjfqdfkb ( real_T x )
; static real_T awcqwgsq2h ( real_T x ) ; static real_T iq4ufpiaqx ( real_T x
) ; static real_T blm1yigmkw ( real_T x ) ; static real_T hvcenrswn3 ( real_T
x ) ; static real_T gbnz1x3utg ( real_T x ) ; static real_T jhbg53gnqu (
real_T x ) ; static real_T gs31rbz5cj ( real_T x ) ; static real_T huspjytxds
( real_T x ) ; static real_T cfvpssv15v ( real_T x ) ; static real_T
nmnxfylg4p ( real_T x ) ; static real_T pttnzsh4jr ( real_T x ) ; static
real_T bencfm2cdn ( real_T x ) ; static real_T lmddk5ikeu ( real_T x ) ;
static real_T kfuzakuyzv ( real_T x ) ; static real_T eemzll5y2c ( real_T x )
; static real_T l535vvla4r ( real_T x ) ; static real_T coc3kb2bg1 ( real_T x
) ; static real_T hyggpaubtc ( real_T x ) ; static real_T m4k1c2prii ( real_T
x ) ; static real_T g32lbjj2f1 ( real_T x ) ; static real_T ocryccyqr2 (
real_T x ) ; static real_T bevch0xzmo ( real_T x ) ; static real_T dct5tv2opv
( real_T x ) ; static real_T g5iu13uqdx ( real_T x ) ; static void porynnud1t
( const real_T inputs [ 6 ] , real_T inputMFCache [ 102 ] ) ; static void
iarf0zxn4d ( const real_T inputs [ 6 ] , real_T outputMFCache [ 17 ] ) ;
static int32_T f5lw1frv04 ( int32_T x ) ; static real_T j1fhb2ttvv ( const
real_T x [ 2 ] ) ; static real_T bmzcvo0p3n ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.38146972817401448 ) * ( x - -
0.38146972817401448 ) ) / 0.64369415990745671 ) ; } static real_T bmzcvo0p3no
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.58767024969839177 ) * (
x - 0.58767024969839177 ) ) / 0.6436941521545253 ) ; } static real_T
bmzcvo0p3nof ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.13464935072142706 ) * ( x - 0.13464935072142706 ) ) / 0.64369415287549292 )
; } static real_T bmzcvo0p3nofd ( real_T x ) { return muDoubleScalarExp ( - (
( x - - 0.028833256254295107 ) * ( x - - 0.028833256254295107 ) ) /
0.64369411094501394 ) ; } static real_T bmzcvo0p3nofde ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.26928494480986392 ) * ( x -
0.26928494480986392 ) ) / 0.64369416893503018 ) ; } static real_T
bmzcvo0p3nofde2 ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.83547877061091835 ) * ( x - 0.83547877061091835 ) ) / 0.64369395680360431 )
; } static real_T hahjh0cqdh ( real_T x ) { return muDoubleScalarExp ( - ( (
x - - 0.83595000343600956 ) * ( x - - 0.83595000343600956 ) ) /
0.64369414897407318 ) ; } static real_T ozjygdmcl0 ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.54938913609757234 ) * ( x -
0.54938913609757234 ) ) / 0.64369419621304513 ) ; } static real_T p0mcyrspyt
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.32065947574966264 ) *
( x - - 0.32065947574966264 ) ) / 0.64369434861210606 ) ; } static real_T
mhzimhcwrv ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.93060528315806257 ) * ( x - - 0.93060528315806257 ) ) / 0.643694194631872 )
; } static real_T mkhx2ajthp ( real_T x ) { return muDoubleScalarExp ( - ( (
x - 0.70730875222237144 ) * ( x - 0.70730875222237144 ) ) / 0.643694166282754
) ; } static real_T nlkytdfkd0 ( real_T x ) { return muDoubleScalarExp ( - (
( x - 0.64870227887416165 ) * ( x - 0.64870227887416165 ) ) /
0.64369416026215731 ) ; } static real_T jnknbil0xi ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.043381106898122183 ) * ( x -
0.043381106898122183 ) ) / 0.64369403281673676 ) ; } static real_T patfsraimm
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.53285148185070041 ) * (
x - 0.53285148185070041 ) ) / 0.643694204406914 ) ; } static real_T
cucglj540b ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
1.7705250474504874 ) * ( x - - 1.7705250474504874 ) ) / 0.64369436510419542 )
; } static real_T ogq5bebiik ( real_T x ) { return muDoubleScalarExp ( - ( (
x - - 1.1754269775448882 ) * ( x - - 1.1754269775448882 ) ) /
0.64369433602827175 ) ; } static real_T ngyjjhi1zl ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 1.0477617635596304 ) * ( x - -
1.0477617635596304 ) ) / 0.64369421938751115 ) ; } static real_T bu3s5hohn4 (
real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.091140350162492612 ) * (
x - 0.091140350162492612 ) ) / 0.64369422051177516 ) ; } static real_T
kxgbz20klu ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.34072171660129863 ) * ( x - 0.34072171660129863 ) ) / 0.64369416530134649 )
; } static real_T gt0euygakx ( real_T x ) { return muDoubleScalarExp ( - ( (
x - - 0.69709880140894309 ) * ( x - - 0.69709880140894309 ) ) /
0.6436941581052571 ) ; } static real_T cqhezzc3df ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.65157356414524159 ) * ( x -
0.65157356414524159 ) ) / 0.64369414497513078 ) ; } static real_T egh352mxwv
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.12047570821053072 ) *
( x - - 0.12047570821053072 ) ) / 0.64369418739907447 ) ; } static real_T
kgnzygto43 ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.11931524730275811 ) * ( x - 0.11931524730275811 ) ) / 0.64369418612793583 )
; } static real_T dchdafquco ( real_T x ) { return muDoubleScalarExp ( - ( (
x - - 0.65235205283522835 ) * ( x - - 0.65235205283522835 ) ) /
0.64369413073392179 ) ; } static real_T f0stdv0qsz ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 1.0593189989272198 ) * ( x - -
1.0593189989272198 ) ) / 0.64369416630563758 ) ; } static real_T bpgecejhpq (
real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.79971647279661062 ) * ( x
- 0.79971647279661062 ) ) / 0.64369437805423213 ) ; } static real_T
dkwmvdok1w ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.66413923825942855 ) * ( x - 0.66413923825942855 ) ) / 0.64369418512873555 )
; } static real_T nxbh2azmdh ( real_T x ) { return muDoubleScalarExp ( - ( (
x - 1.1095789991911795 ) * ( x - 1.1095789991911795 ) ) / 0.64369415471723768
) ; } static real_T ffgmujot5v ( real_T x ) { return muDoubleScalarExp ( - (
( x - 0.8354787337604126 ) * ( x - 0.8354787337604126 ) ) /
0.64369414944165948 ) ; } static real_T jvnvwzhhvf ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.52647735577825383 ) * ( x -
0.52647735577825383 ) ) / 0.64369376089308783 ) ; } static real_T a4mmwpbrs5
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.66021497704701815 ) * (
x - 0.66021497704701815 ) ) / 0.64369420156139523 ) ; } static real_T
k254wgfo5k ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.041058053910497286 ) * ( x - - 0.041058053910497286 ) ) /
0.64369442308192526 ) ; } static real_T oik3dynthb ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.88661454441544107 ) * ( x -
0.88661454441544107 ) ) / 0.64369410385801762 ) ; } static real_T hfhajfa010
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 1.5648170195022812 ) *
( x - - 1.5648170195022812 ) ) / 0.64369411125427156 ) ; } static real_T
pzoxdxg5q5 ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.15220149156782525 ) * ( x - - 0.15220149156782525 ) ) / 0.6436942504091695
) ; } static real_T hqrqynqisg ( real_T x ) { return muDoubleScalarExp ( - (
( x - 0.36564401076348529 ) * ( x - 0.36564401076348529 ) ) /
0.64369413927111885 ) ; } static real_T nsvq13xquu ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.37285731120806664 ) * ( x -
0.37285731120806664 ) ) / 0.64369410416090367 ) ; } static real_T eca3tx2uet
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.371817480551214 ) * ( x
- 0.371817480551214 ) ) / 0.64369397353054059 ) ; } static real_T f05zto01zx
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.53285150466688214 ) * (
x - 0.53285150466688214 ) ) / 0.64369421930381132 ) ; } static real_T
d2km4x2m42 ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.90604229347375 ) * ( x - - 0.90604229347375 ) ) / 0.64369417485982772 ) ; }
static real_T i5nyhlozor ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.26928490986833392 ) * ( x - 0.26928490986833392 ) ) / 0.64369401045855446 )
; } static real_T nezhlmbv4d ( real_T x ) { return muDoubleScalarExp ( - ( (
x - - 0.97996803046999414 ) * ( x - - 0.97996803046999414 ) ) /
0.64369415591432622 ) ; } static real_T mvuwg1yb3x ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.65689698222451043 ) * ( x - -
0.65689698222451043 ) ) / 0.6436944103666371 ) ; } static real_T b0w4cxcqjy (
real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.39200132246687613 ) * ( x
- 0.39200132246687613 ) ) / 0.64369421235592539 ) ; } static real_T
hxprwsi21x ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.10465888061424199 ) * ( x - 0.10465888061424199 ) ) / 0.64369419688443719 )
; } static real_T dqdjfqdfkb ( real_T x ) { return muDoubleScalarExp ( - ( (
x - 0.11931520407023298 ) * ( x - 0.11931520407023298 ) ) /
0.64369409317894888 ) ; } static real_T awcqwgsq2h ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.23683316924987585 ) * ( x -
0.23683316924987585 ) ) / 0.64369383361489374 ) ; } static real_T iq4ufpiaqx
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 1.0477618248575269 ) *
( x - - 1.0477618248575269 ) ) / 0.643694072334084 ) ; } static real_T
blm1yigmkw ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.51094840707955469 ) * ( x - - 0.51094840707955469 ) ) / 0.64369420056066118
) ; } static real_T hvcenrswn3 ( real_T x ) { return muDoubleScalarExp ( - (
( x - 1.438697193534749 ) * ( x - 1.438697193534749 ) ) / 0.64369330612678366
) ; } static real_T gbnz1x3utg ( real_T x ) { return muDoubleScalarExp ( - (
( x - 1.1552877163923609 ) * ( x - 1.1552877163923609 ) ) /
0.64369342235496751 ) ; } static real_T jhbg53gnqu ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.33670568558187819 ) * ( x - -
0.33670568558187819 ) ) / 1.266378069756009 ) ; } static real_T gs31rbz5cj (
real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.40048603288462997 ) * ( x
- 0.40048603288462997 ) ) / 1.2663779961630732 ) ; } static real_T huspjytxds
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 1.132999900155103 ) * ( x
- 1.132999900155103 ) ) / 1.266378090131747 ) ; } static real_T cfvpssv15v (
real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.56247395656460975 ) * ( x
- 0.56247395656460975 ) ) / 1.2663782398285268 ) ; } static real_T nmnxfylg4p
( real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.9778142327021081 ) *
( x - - 0.9778142327021081 ) ) / 1.2663780965048008 ) ; } static real_T
pttnzsh4jr ( real_T x ) { return muDoubleScalarExp ( - ( ( x -
0.72864156780584532 ) * ( x - 0.72864156780584532 ) ) / 1.2663780714728758 )
; } static real_T bencfm2cdn ( real_T x ) { return muDoubleScalarExp ( - ( (
x - 0.31768794706186987 ) * ( x - 0.31768794706186987 ) ) / 1.266378047808923
) ; } static real_T lmddk5ikeu ( real_T x ) { return muDoubleScalarExp ( - (
( x - - 0.044880607165546843 ) * ( x - - 0.044880607165546843 ) ) /
1.2663781096448359 ) ; } static real_T kfuzakuyzv ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 0.57735033221917043 ) * ( x -
0.57735033221917043 ) ) / 1.2663784173985342 ) ; } static real_T eemzll5y2c (
real_T x ) { return muDoubleScalarExp ( - ( ( x - - 0.70116532006544285 ) * (
x - - 0.70116532006544285 ) ) / 1.2663781996659433 ) ; } static real_T
l535vvla4r ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.50770033929730463 ) * ( x - - 0.50770033929730463 ) ) / 1.2663781077886198
) ; } static real_T coc3kb2bg1 ( real_T x ) { return muDoubleScalarExp ( - (
( x - - 2.377454306392135 ) * ( x - - 2.377454306392135 ) ) /
1.2663780284776855 ) ; } static real_T hyggpaubtc ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - 2.0184961826206003 ) * ( x - 2.0184961826206003
) ) / 1.2663779149146648 ) ; } static real_T m4k1c2prii ( real_T x ) { return
muDoubleScalarExp ( - ( ( x - - 0.27135431448475333 ) * ( x - -
0.27135431448475333 ) ) / 1.2663781741017845 ) ; } static real_T g32lbjj2f1 (
real_T x ) { return muDoubleScalarExp ( - ( ( x - 1.1586547320299956 ) * ( x
- 1.1586547320299956 ) ) / 1.26637788114129 ) ; } static real_T ocryccyqr2 (
real_T x ) { return muDoubleScalarExp ( - ( ( x - 0.0349733973393954 ) * ( x
- 0.0349733973393954 ) ) / 1.2663779866207765 ) ; } static real_T bevch0xzmo
( real_T x ) { return muDoubleScalarExp ( - ( ( x - 1.1226479165064942 ) * (
x - 1.1226479165064942 ) ) / 1.2663780648693339 ) ; } static real_T
dct5tv2opv ( real_T x ) { return muDoubleScalarExp ( - ( ( x - -
0.55709363694595881 ) * ( x - - 0.55709363694595881 ) ) / 1.2663780823112094
) ; } static real_T g5iu13uqdx ( real_T x ) { return muDoubleScalarExp ( - (
( x - 0.75621896882907558 ) * ( x - 0.75621896882907558 ) ) /
1.2663780694316586 ) ; } static void porynnud1t ( const real_T inputs [ 6 ] ,
real_T inputMFCache [ 102 ] ) { inputMFCache [ 0 ] = bmzcvo0p3n ( inputs [ 0
] ) ; inputMFCache [ 1 ] = bmzcvo0p3no ( inputs [ 0 ] ) ; inputMFCache [ 2 ]
= bmzcvo0p3nof ( inputs [ 0 ] ) ; inputMFCache [ 3 ] = bmzcvo0p3nofd ( inputs
[ 0 ] ) ; inputMFCache [ 4 ] = bmzcvo0p3nofde ( inputs [ 0 ] ) ; inputMFCache
[ 5 ] = bmzcvo0p3nofde2 ( inputs [ 0 ] ) ; inputMFCache [ 6 ] = hahjh0cqdh (
inputs [ 0 ] ) ; inputMFCache [ 7 ] = ozjygdmcl0 ( inputs [ 0 ] ) ;
inputMFCache [ 8 ] = p0mcyrspyt ( inputs [ 0 ] ) ; inputMFCache [ 9 ] =
mhzimhcwrv ( inputs [ 0 ] ) ; inputMFCache [ 10 ] = mkhx2ajthp ( inputs [ 0 ]
) ; inputMFCache [ 11 ] = nlkytdfkd0 ( inputs [ 0 ] ) ; inputMFCache [ 12 ] =
jnknbil0xi ( inputs [ 0 ] ) ; inputMFCache [ 13 ] = patfsraimm ( inputs [ 0 ]
) ; inputMFCache [ 14 ] = cucglj540b ( inputs [ 0 ] ) ; inputMFCache [ 15 ] =
ogq5bebiik ( inputs [ 0 ] ) ; inputMFCache [ 16 ] = ngyjjhi1zl ( inputs [ 0 ]
) ; inputMFCache [ 17 ] = bu3s5hohn4 ( inputs [ 1 ] ) ; inputMFCache [ 18 ] =
kxgbz20klu ( inputs [ 1 ] ) ; inputMFCache [ 19 ] = gt0euygakx ( inputs [ 1 ]
) ; inputMFCache [ 20 ] = cqhezzc3df ( inputs [ 1 ] ) ; inputMFCache [ 21 ] =
egh352mxwv ( inputs [ 1 ] ) ; inputMFCache [ 22 ] = kgnzygto43 ( inputs [ 1 ]
) ; inputMFCache [ 23 ] = dchdafquco ( inputs [ 1 ] ) ; inputMFCache [ 24 ] =
f0stdv0qsz ( inputs [ 1 ] ) ; inputMFCache [ 25 ] = bpgecejhpq ( inputs [ 1 ]
) ; inputMFCache [ 26 ] = dkwmvdok1w ( inputs [ 1 ] ) ; inputMFCache [ 27 ] =
nxbh2azmdh ( inputs [ 1 ] ) ; inputMFCache [ 28 ] = ffgmujot5v ( inputs [ 1 ]
) ; inputMFCache [ 29 ] = jvnvwzhhvf ( inputs [ 1 ] ) ; inputMFCache [ 30 ] =
a4mmwpbrs5 ( inputs [ 1 ] ) ; inputMFCache [ 31 ] = k254wgfo5k ( inputs [ 1 ]
) ; inputMFCache [ 32 ] = oik3dynthb ( inputs [ 1 ] ) ; inputMFCache [ 33 ] =
hfhajfa010 ( inputs [ 1 ] ) ; inputMFCache [ 34 ] = pzoxdxg5q5 ( inputs [ 2 ]
) ; inputMFCache [ 35 ] = hqrqynqisg ( inputs [ 2 ] ) ; inputMFCache [ 36 ] =
nsvq13xquu ( inputs [ 2 ] ) ; inputMFCache [ 37 ] = eca3tx2uet ( inputs [ 2 ]
) ; inputMFCache [ 38 ] = f05zto01zx ( inputs [ 2 ] ) ; inputMFCache [ 39 ] =
d2km4x2m42 ( inputs [ 2 ] ) ; inputMFCache [ 40 ] = i5nyhlozor ( inputs [ 2 ]
) ; inputMFCache [ 41 ] = nezhlmbv4d ( inputs [ 2 ] ) ; inputMFCache [ 42 ] =
mvuwg1yb3x ( inputs [ 2 ] ) ; inputMFCache [ 43 ] = b0w4cxcqjy ( inputs [ 2 ]
) ; inputMFCache [ 44 ] = hxprwsi21x ( inputs [ 2 ] ) ; inputMFCache [ 45 ] =
dqdjfqdfkb ( inputs [ 2 ] ) ; inputMFCache [ 46 ] = awcqwgsq2h ( inputs [ 2 ]
) ; inputMFCache [ 47 ] = iq4ufpiaqx ( inputs [ 2 ] ) ; inputMFCache [ 48 ] =
blm1yigmkw ( inputs [ 2 ] ) ; inputMFCache [ 49 ] = hvcenrswn3 ( inputs [ 2 ]
) ; inputMFCache [ 50 ] = gbnz1x3utg ( inputs [ 2 ] ) ; inputMFCache [ 51 ] =
jhbg53gnqu ( inputs [ 3 ] ) ; inputMFCache [ 52 ] = gs31rbz5cj ( inputs [ 3 ]
) ; inputMFCache [ 53 ] = huspjytxds ( inputs [ 3 ] ) ; inputMFCache [ 54 ] =
cfvpssv15v ( inputs [ 3 ] ) ; inputMFCache [ 55 ] = nmnxfylg4p ( inputs [ 3 ]
) ; inputMFCache [ 56 ] = pttnzsh4jr ( inputs [ 3 ] ) ; inputMFCache [ 57 ] =
bencfm2cdn ( inputs [ 3 ] ) ; inputMFCache [ 58 ] = lmddk5ikeu ( inputs [ 3 ]
) ; inputMFCache [ 59 ] = kfuzakuyzv ( inputs [ 3 ] ) ; inputMFCache [ 60 ] =
eemzll5y2c ( inputs [ 3 ] ) ; inputMFCache [ 61 ] = l535vvla4r ( inputs [ 3 ]
) ; inputMFCache [ 62 ] = coc3kb2bg1 ( inputs [ 3 ] ) ; inputMFCache [ 63 ] =
hyggpaubtc ( inputs [ 3 ] ) ; inputMFCache [ 64 ] = m4k1c2prii ( inputs [ 3 ]
) ; inputMFCache [ 65 ] = g32lbjj2f1 ( inputs [ 3 ] ) ; inputMFCache [ 66 ] =
ocryccyqr2 ( inputs [ 3 ] ) ; inputMFCache [ 67 ] = bevch0xzmo ( inputs [ 3 ]
) ; inputMFCache [ 68 ] = dct5tv2opv ( inputs [ 4 ] ) ; inputMFCache [ 69 ] =
g5iu13uqdx ( inputs [ 4 ] ) ; inputMFCache [ 70 ] = muDoubleScalarExp ( - ( (
...
f5lw1frv04 ( int32_T x ) { int32_T y ; if ( x < 0 ) { if ( x <= MIN_int32_T )
{ y = MAX_int32_T ; } else { y = - x ; } } else { y = x ; } return y ; }
static real_T j1fhb2ttvv ( const real_T x [ 2 ] ) { return x [ 0 ] * x [ 1 ]
; } void MdlInitialize ( void ) { rtX . g4oy2nanoh [ 0 ] = 0.0 ; rtX .
g4oy2nanoh [ 1 ] = 0.0 ; rtX . g4oy2nanoh [ 2 ] = 0.0 ; rtDW . futr4qzytw =
rtP . UnitDelay3_InitialCondition ; rtDW . kjntowhetd = rtP .
UnitDelay4_InitialCondition ; rtDW . fwxdexslg2 = rtP .
UnitDelay5_InitialCondition ; rtDW . bw5phhsufr = rtP .
UnitDelay_InitialCondition ; rtDW . mnsasccrtx = rtP .
UnitDelay1_InitialCondition ; rtDW . dhbf3frvil = rtP .
UnitDelay2_InitialCondition ; rtX . npvc2s2o4q = rtP . Integrator_IC ; } void
...
"ModelSawtoothSubtractive/To Workspace" ; rtDW . ayyzswgilk . LoggedData =
...
ayyzswgilk . LoggedData == ( NULL ) ) return ; } MdlInitialize ( ) ; } void
...
real_T tmp [ 6 ] ; real_T aqoepghf2h [ 2 ] ; int32_T q0 ; int32_T q1 ; rtB .
kx1ansbrv2 = 0.0 ; rtB . kx1ansbrv2 += rtP . TransferFcn_C [ 0 ] * rtX .
g4oy2nanoh [ 0 ] ; rtB . kx1ansbrv2 += rtP . TransferFcn_C [ 1 ] * rtX .
g4oy2nanoh [ 1 ] ; rtB . kx1ansbrv2 += rtP . TransferFcn_C [ 2 ] * rtX .
g4oy2nanoh [ 2 ] ; if ( ssIsSampleHit ( rtS , 1 , 0 ) ) { rtB . aomhpygqjx =
rtDW . futr4qzytw ; rtB . dxp0prdiug = rtDW . kjntowhetd ; rtB . fyf3jmqibf =
rtDW . fwxdexslg2 ; rtB . ldmnkugrml = rtDW . bw5phhsufr ; rtB . i3fjizqyfz =
rtDW . mnsasccrtx ; rtB . bskjlbtzwj = rtDW . dhbf3frvil ; if ( ssIsSampleHit
( rtS , 1 , 0 ) ) { sumAntecedentOutputs = 0.0 ; tmp [ 0 ] = rtB . aomhpygqjx
; tmp [ 1 ] = rtB . dxp0prdiug ; tmp [ 2 ] = rtB . fyf3jmqibf ; tmp [ 3 ] =
rtB . ldmnkugrml ; tmp [ 4 ] = rtB . i3fjizqyfz ; tmp [ 5 ] = rtB .
bskjlbtzwj ; porynnud1t ( tmp , inputMFCache ) ; aggregatedOutputs = 0.0 ;
tmp [ 0 ] = rtB . aomhpygqjx ; tmp [ 1 ] = rtB . dxp0prdiug ; tmp [ 2 ] = rtB
. fyf3jmqibf ; tmp [ 3 ] = rtB . ldmnkugrml ; tmp [ 4 ] = rtB . i3fjizqyfz ;
tmp [ 5 ] = rtB . bskjlbtzwj ; iarf0zxn4d ( tmp , outputMFCache ) ; for ( iy
= 0 ; iy < 17 ; iy ++ ) { cjmbdwlftv [ iy ] = 1.0 ; for ( inputID = 0 ;
inputID < 6 ; inputID ++ ) { q0 = f5lw1frv04 ( 17 * inputID ) ; aqoepghf2h [
0 ] = cjmbdwlftv [ iy ] ; q1 = b [ 17 * inputID + iy ] ; if ( ( q0 < 0 ) && (
q1 < MIN_int32_T - q0 ) ) { q0 = MIN_int32_T ; } else if ( ( q0 > 0 ) && ( q1
> MAX_int32_T - q0 ) ) { q0 = MAX_int32_T ; } else { q0 += q1 ; } aqoepghf2h
[ 1 ] = inputMFCache [ q0 - 1 ] ; cjmbdwlftv [ iy ] = j1fhb2ttvv ( aqoepghf2h
) ; } sumAntecedentOutputs += cjmbdwlftv [ iy ] ; aggregatedOutputs +=
outputMFCache [ iy ] * cjmbdwlftv [ iy ] ; } if ( sumAntecedentOutputs == 0.0
) { rtB . pwtqq4vdpb = - 0.1526961 ; } else { rtB . pwtqq4vdpb = 1.0 /
sumAntecedentOutputs * aggregatedOutputs ; } } } rtB . gzcppo4l1p = rtX .
npvc2s2o4q ; { double locTime = ssGetTaskTime ( rtS , 0 ) ; ; if (
...
StructLogVar * ) rtDW . ayyzswgilk . LoggedData , & locTime , & rtB .
gzcppo4l1p ) ; } } } } if ( ssIsSampleHit ( rtS , 2 , 0 ) ) { } if (
ssIsSampleHit ( rtS , 1 , 0 ) && ssIsSampleHit ( rtS , 2 , 0 ) ) { rtB .
e4gzxtn2iq [ 0 ] = rtB . aomhpygqjx ; rtB . e4gzxtn2iq [ 1 ] = rtB .
dxp0prdiug ; rtB . e4gzxtn2iq [ 2 ] = rtB . fyf3jmqibf ; rtB . e4gzxtn2iq [ 3
] = rtB . ldmnkugrml ; rtB . e4gzxtn2iq [ 4 ] = rtB . i3fjizqyfz ; rtB .
e4gzxtn2iq [ 5 ] = rtB . bskjlbtzwj ; } rtB . dh3u5ghzt1 = rtB . kx1ansbrv2 -
rtB . pwtqq4vdpb ; rtB . o3i1c3gu0d = rtB . dh3u5ghzt1 * rtB . dh3u5ghzt1 ;
sumAntecedentOutputs = rtP . SignalGenerator_Frequency * ssGetT ( rtS ) ; rtB
. mffkwrg3se = ( 1.0 - ( sumAntecedentOutputs - muDoubleScalarFloor (
sumAntecedentOutputs ) ) * 2.0 ) * rtP . SignalGenerator_Amplitude ;
UNUSED_PARAMETER ( tid ) ; } void MdlUpdate ( int_T tid ) { if (
ssIsSampleHit ( rtS , 1 , 0 ) ) { rtDW . futr4qzytw = rtB . kx1ansbrv2 ; rtDW
. kjntowhetd = rtB . aomhpygqjx ; rtDW . fwxdexslg2 = rtB . dxp0prdiug ; rtDW
. bw5phhsufr = rtB . mffkwrg3se ; rtDW . mnsasccrtx = rtB . ldmnkugrml ; rtDW
. dhbf3frvil = rtB . i3fjizqyfz ; } if ( ssIsSampleHit ( rtS , 2 , 0 ) ) { }
UNUSED_PARAMETER ( tid ) ; } void MdlUpdateTID3 ( int_T tid ) {
UNUSED_PARAMETER ( tid ) ; } void MdlDerivatives ( void ) { XDot * _rtXdot ;
_rtXdot = ( ( XDot * ) ssGetdX ( rtS ) ) ; _rtXdot -> g4oy2nanoh [ 0 ] = 0.0
; _rtXdot -> g4oy2nanoh [ 0 ] += rtP . TransferFcn_A [ 0 ] * rtX . g4oy2nanoh
[ 0 ] ; _rtXdot -> g4oy2nanoh [ 1 ] = 0.0 ; _rtXdot -> g4oy2nanoh [ 0 ] +=
rtP . TransferFcn_A [ 1 ] * rtX . g4oy2nanoh [ 1 ] ; _rtXdot -> g4oy2nanoh [
2 ] = 0.0 ; _rtXdot -> g4oy2nanoh [ 0 ] += rtP . TransferFcn_A [ 2 ] * rtX .
g4oy2nanoh [ 2 ] ; _rtXdot -> g4oy2nanoh [ 1 ] += rtX . g4oy2nanoh [ 0 ] ;
_rtXdot -> g4oy2nanoh [ 2 ] += rtX . g4oy2nanoh [ 1 ] ; _rtXdot -> g4oy2nanoh
[ 0 ] += rtB . mffkwrg3se ; _rtXdot -> npvc2s2o4q = rtB . o3i1c3gu0d ; } void
...
void raccel_set_checksum ( ) { ssSetChecksumVal ( rtS , 0 , 4104700583U ) ;
ssSetChecksumVal ( rtS , 1 , 745064595U ) ; ssSetChecksumVal ( rtS , 2 ,
633582382U ) ; ssSetChecksumVal ( rtS , 3 , 3007835611U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
ModelSawtoothSubtractive_InitializeDataMapInfo ( ) ;
ssSetIsRapidAcceleratorActive ( rtS , true ) ; ssSetRootSS ( rtS , rtS ) ;
ssSetVersion ( rtS , SIMSTRUCT_VERSION_LEVEL2 ) ; ssSetModelName ( rtS ,
"ModelSawtoothSubtractive" ) ; ssSetPath ( rtS , "ModelSawtoothSubtractive" )
; ssSetTStart ( rtS , 0.0 ) ; ssSetTFinal ( rtS , 500.0 ) ; { static
...
pwtqq4vdpb ) , ( NULL ) } } ; ssSetSolverRelTol ( rtS , 0.0001 ) ;
...
ssSetChecksumVal ( rtS , 0 , 4104700583U ) ; ssSetChecksumVal ( rtS , 1 ,
745064595U ) ; ssSetChecksumVal ( rtS , 2 , 633582382U ) ; ssSetChecksumVal (
rtS , 3 , 3007835611U ) ; { static const sysRanDType rtAlwaysEnabled =
